...
uint256 hashGenesisBlock("0x294e13ec33211a8d8acdee95548e944b1f46bd138ba07303cf6ca564a9c81a7d");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(537261531); // BakedCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BakedCoin Signed Message:\n";
...
{
    // BakedCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    else if (nHeight < 7200) { nSubsidy = 2000000000; } // 20 BAKED reward for Day 5 28,800 Total
        else { nSubsidy = 1000000000; } // 10 BAKED reward Flat Rate

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 360; // BakedCoin: 5 Minutes or 6 Blocks until DGW3 retargeting for every block starts
static const int64 nTargetSpacing = 60; // BakedCoin: 60 Seconds
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BakedCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BakedCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // BakedCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb3db53b8d4c5a7230e565df27c030896264b645763f88c48c329ca1d3f872b1a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Baked Not Fried 2017";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("b88524d3a1587589da0de6f60a813376018f15e6761dd363bffa70cbe3e8442f1d4e16687281ac408c3da3c3172e1576b5143cebd592b49948a6ce1821b4c8c2fe") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1487728852;
        block.nBits    = 537261531;
        block.nNonce   = 1013189836;

        if (fTestNet)
        {
            block.nTime    = 1487728852;
            block.nNonce   = 3768399050;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2fc6d86f66283056da09e8a9a3b1fc7a8d7af493f9ae9395b9820d5ac8e21991"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // BakedCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BakedCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BakedCoinMiner : ProcessBlock, block not accepted");
    }
